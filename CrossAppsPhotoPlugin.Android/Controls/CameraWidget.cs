...
using CrossAppsPhotoPlugin.Android.Listeners;
using Java.IO;
using Java.Lang;
using Java.Util;
...
namespace CrossAppsPhotoPlugin.Android.Controls
{
    public class CameraWidget : View
    {
        ...
        public void SwitchCamera()
        {
            ...
            if (cameraInteger == (int)CameraFacing.Back)
            {
                mCameraId = ((int)CameraFacing.Front).ToString();
            }
            else
            {
                mCameraId = ((int)CameraFacing.Back).ToString();
            }
